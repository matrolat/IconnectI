...
const {companyRegistration, login, allUsers, otpVerify, logout, mainScreen, collegeRegistration, deleteData, forgotPassword,resetPassword, checkReset} = require("../controller/userController")
...
router.post('/activate',Authenticate, upload.single('logo'),companyActivation);
router.get('/getActivationDetails/:email',Authenticate, getActivationDetails);
router.post('/internPosting',Authenticate,internPosting);
router.post('/getAllPosting',Authenticate,getAllPosting);
